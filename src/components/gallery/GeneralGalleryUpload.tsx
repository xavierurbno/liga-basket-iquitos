    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        ...
        <input
          type="text"
          name="caption"
          placeholder="Ej: Inauguración Temporada 2026 · LDDBI"
        ...
        <p className="mt-1 text-[10px] text-slate-400">
          El caption se aplica a todas las fotos y aparecerá en el carrusel del dashboard.
        </p>
      </div>
      ...
      <AnimatePresence>
        ...
        {success && (
          ...
          >
            ...
            ¡Fotos subidas! Aparecerán en el carrusel del dashboard.
          </motion.p>
        )}
      </AnimatePresence>
      ...
      >
        {isPending ? (
          ...
          <>
            ...
            <span>SUBIR {selectedFiles.length > 0 ? `${selectedFiles.length} ` : ""}FOTOS A LA LIGA</span>
          </>
        )}
      </button>
    </form>
